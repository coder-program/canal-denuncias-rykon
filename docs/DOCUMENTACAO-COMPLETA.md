...
**Métricas Secundárias:** 5. **LTV Médio:** R$ 12.400 (Lifetime Value) 6. **Taxa de Conversão:** 23,5% (Trial → Paid) 7. **Churn Rate:** 2,4% (Taxa de cancelamento mensal) 8. **Pendentes:** R$ 2.680 em faturas não pagas
...
- stripePublicKey: 'pk*test*••••••••••••••••'
- stripeSecretKey: 'sk*test*••••••••••••••••'
- stripeWebhookSecret: 'whsec\_••••••••••••••••'
- defaultCurrency: 'BRL'
- taxEnabled: false
- taxPercentage: 0
