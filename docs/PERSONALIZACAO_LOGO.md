...
<div className="flex items-center gap-4">
  {/* Logo Institucional */}
  <img src="/logo-empresa.png" alt="Logo da Empresa" className="h-16 w-auto" />
  <div>
...
<Link href="/" className="flex items-center gap-4">
  <img src="/logo-empresa.png" alt="Logo da Empresa" className="h-12 w-auto" />
  <div>
...
```tsx
<img src="/logo-empresa.png" alt="Logo da Empresa" className="h-16 w-auto rounded-xl shadow-lg" />
```
